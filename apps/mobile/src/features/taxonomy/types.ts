...
export type GlobalRole =
  ...
  | 'topic'
  | 'duration'
  /** 언제 여는가. 공구 오픈 시각처럼 '시작하는 때'입니다. 마감과 짝입니다. */
  | 'start'
  /**
   * 어떻게 사는가. 공동구매·예약구매처럼 **특별한** 구매 방식만 담습니다.
   *
   * 분야를 넘습니다. 제주 숙박 공동구매는 분야가 여행이고, 기저귀 공동구매는 육아입니다.
   * 분야 안에 두면 '내 공구 모아보기'가 영영 성립하지 않습니다.
   */
  | 'purchase';
